...
import uk.kcl.pgt.mdd.cw.generator.GameGenerator;
import uk.kcl.pgt.mdd.cw.parser.antlr.GameAntlrTokenFileProvider;
import uk.kcl.pgt.mdd.cw.parser.antlr.GameParser;
import uk.kcl.pgt.mdd.cw.parser.antlr.internal.InternalGameLexer;
import uk.kcl.pgt.mdd.cw.scoping.GameScopeProvider;
import uk.kcl.pgt.mdd.cw.serializer.GameSemanticSequencer;
import uk.kcl.pgt.mdd.cw.serializer.GameSyntacticSequencer;
import uk.kcl.pgt.mdd.cw.services.GameGrammarAccess;
import uk.kcl.pgt.mdd.cw.validation.GameConfigurableIssueCodesProvider;
import uk.kcl.pgt.mdd.cw.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "uk/kcl/pgt/mdd/cw/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("uk.kcl.pgt.mdd.cw.Game");
	}
