...
public interface GameFactory extends EFactory
{
   ...
   * @generated
   */
  GameFactory eINSTANCE = uk.kcl.pgt.mdd.cw.game.impl.GameFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>End Stmt</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>End Stmt</em>'.
   * @generated
   */
  EndStmt createEndStmt();
