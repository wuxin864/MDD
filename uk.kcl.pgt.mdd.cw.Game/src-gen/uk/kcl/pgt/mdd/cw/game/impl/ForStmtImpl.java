 ...
 * </p>
 * <ul>
 *   <li>{@link uk.kcl.pgt.mdd.cw.game.impl.ForStmtImpl#getInitStmt <em>Init Stmt</em>}</li>
 *   <li>{@link uk.kcl.pgt.mdd.cw.game.impl.ForStmtImpl#getEndCondition <em>End Condition</em>}</li>
 *   <li>{@link uk.kcl.pgt.mdd.cw.game.impl.ForStmtImpl#getLoopStmt <em>Loop Stmt</em>}</li>
 *   <li>{@link uk.kcl.pgt.mdd.cw.game.impl.ForStmtImpl#getStmtBlock <em>Stmt Block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForStmtImpl extends StmtImpl implements ForStmt
{
  ...
  {
    return GamePackage.Literals.FOR_STMT;
  }
  ...
  public NotificationChain basicSetInitStmt(AssStmt newInitStmt, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__INIT_STMT, oldInitStmt, newInitStmt);
  ...
  public void setInitStmt(AssStmt newInitStmt)
  {
    if (newInitStmt != initStmt)
    {
      ...
      if (initStmt != null)
        msgs = ((InternalEObject)initStmt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__INIT_STMT, null, msgs);
      if (newInitStmt != null)
        msgs = ((InternalEObject)newInitStmt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__INIT_STMT, null, msgs);
      msgs = basicSetInitStmt(newInitStmt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__INIT_STMT, newInitStmt, newInitStmt));
  }
  ...
  public NotificationChain basicSetEndCondition(Expression newEndCondition, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__END_CONDITION, oldEndCondition, newEndCondition);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setEndCondition(Expression newEndCondition)
  {
    if (newEndCondition != endCondition)
    {
      ...
      if (endCondition != null)
        msgs = ((InternalEObject)endCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__END_CONDITION, null, msgs);
      if (newEndCondition != null)
        msgs = ((InternalEObject)newEndCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__END_CONDITION, null, msgs);
      msgs = basicSetEndCondition(newEndCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__END_CONDITION, newEndCondition, newEndCondition));
  }
  ...
  public NotificationChain basicSetLoopStmt(AssStmt newLoopStmt, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__LOOP_STMT, oldLoopStmt, newLoopStmt);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLoopStmt(AssStmt newLoopStmt)
  {
    if (newLoopStmt != loopStmt)
    {
      NotificationChain msgs = null;
      if (loopStmt != null)
        msgs = ((InternalEObject)loopStmt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__LOOP_STMT, null, msgs);
      if (newLoopStmt != null)
        msgs = ((InternalEObject)newLoopStmt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__LOOP_STMT, null, msgs);
      msgs = basicSetLoopStmt(newLoopStmt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__LOOP_STMT, newLoopStmt, newLoopStmt));
  }
  ...
  public NotificationChain basicSetStmtBlock(StmtBlock newStmtBlock, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__STMT_BLOCK, oldStmtBlock, newStmtBlock);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStmtBlock(StmtBlock newStmtBlock)
  {
    if (newStmtBlock != stmtBlock)
    {
      NotificationChain msgs = null;
      if (stmtBlock != null)
        msgs = ((InternalEObject)stmtBlock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__STMT_BLOCK, null, msgs);
      if (newStmtBlock != null)
        msgs = ((InternalEObject)newStmtBlock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GamePackage.FOR_STMT__STMT_BLOCK, null, msgs);
      msgs = basicSetStmtBlock(newStmtBlock, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.FOR_STMT__STMT_BLOCK, newStmtBlock, newStmtBlock));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GamePackage.FOR_STMT__INIT_STMT:
        return basicSetInitStmt(null, msgs);
      case GamePackage.FOR_STMT__END_CONDITION:
        return basicSetEndCondition(null, msgs);
      case GamePackage.FOR_STMT__LOOP_STMT:
        return basicSetLoopStmt(null, msgs);
      case GamePackage.FOR_STMT__STMT_BLOCK:
