...
import uk.kcl.pgt.mdd.cw.game.GameFactory;
...
public class GamePackageImpl extends EPackageImpl implements GamePackage
{
   ...
   * @generated
   */
  private EClass endStmtEClass = null;
   ...
   * @see uk.kcl.pgt.mdd.cw.game.GamePackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EReference getWhileStmt_WhileCondition()
  {
   ...
   */
  @Override
  public EReference getWhileStmt_StmtBlock()
  {
   ...
   */
  @Override
  public EClass getEndStmt()
  {
    return endStmtEClass;
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(whileStmtEClass, WHILE_STMT__WHILE_CONDITION);
    createEReference(whileStmtEClass, WHILE_STMT__STMT_BLOCK);
    ...
    endStmtEClass = createEClass(END_STMT);
  ...
  public void initializePackageContents()
  {
    ...
    endStmtEClass.getESuperTypes().add(this.getStmt());
    ...
    intLiteralEClass.getESuperTypes().add(this.getEndStmt());
    ...
    initEReference(getVarDecl_Expr(), this.getExpression(), null, "expr", null, 0, 1, VarDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getWhileStmt_WhileCondition(), this.getExpression(), null, "whileCondition", null, 0, 1, WhileStmt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getWhileStmt_StmtBlock(), this.getStmtBlock(), null, "stmtBlock", null, 0, 1, WhileStmt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(endStmtEClass, EndStmt.class, "EndStmt", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
