...
public class GameSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case GamePackage.END_STMT:
      {
        EndStmt endStmt = (EndStmt)theEObject;
        T result = caseEndStmt(endStmt);
        if (result == null) result = caseStmt(endStmt);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case GamePackage.INT_LITERAL:
      {
        ...
        if (result == null) result = caseEndStmt(intLiteral);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>End Stmt</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>End Stmt</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEndStmt(EndStmt object)
  {
    return null;
  }
