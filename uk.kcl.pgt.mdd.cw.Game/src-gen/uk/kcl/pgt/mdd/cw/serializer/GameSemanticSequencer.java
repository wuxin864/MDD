 ...
 */
package uk.kcl.pgt.mdd.cw.serializer;
...
import uk.kcl.pgt.mdd.cw.game.ExprVar;
...
public class GameSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *     Expr.Operation_1_0 returns Operation
	 *
	 * Constraint:
	 *     (
	 *         (left=Expr_Operation_1_0 op='||' right=AndExpr) | 
	 *         (left=AndExpr_Operation_1_0 op='&&' right=RelExpr) | 
	 *         (left=RelExpr_Operation_1_0 (op='==' | op='<' | op='<=') right=AddExpr) | 
	 *         (left=AddExpr_Operation_1_0 (op='+' | op='-') right=MultExpr) | 
	 *         (left=MultExpr_Operation_1_0 (op='*' | op='/') (right=UnaryExpr | right=Atom)) | 
	 *         (left=Atom_Operation_1_1_0 op='touches' right=Var)
	 *     )
	 */
	protected void sequence_AddExpr_AndExpr_Atom_Expr_MultExpr_RelExpr(ISerializationContext context, Operation semanticObject) {
	...
	protected void sequence_AnimBlock(ISerializationContext context, AnimBlock semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ANIM_BLOCK__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ANIM_BLOCK__NAME));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ANIM_BLOCK__OBJ_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ANIM_BLOCK__OBJ_TYPE));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ANIM_BLOCK__OBJ_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ANIM_BLOCK__OBJ_NAME));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.BLOCK__STMT_BLOCK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.BLOCK__STMT_BLOCK));
		}
	...
	protected void sequence_AssStmt(ISerializationContext context, AssStmt semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ASS_STMT__VAR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ASS_STMT__VAR));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ASS_STMT__ASSIGNMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ASS_STMT__ASSIGNMENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *
	 * Constraint:
	 *     ((left=MultExpr_Operation_1_0 (op='*' | op='/') (right=UnaryExpr | right=Atom)) | (left=Atom_Operation_1_1_0 op='touches' right=Var))
	 */
	...
	protected void sequence_AttrAss(ISerializationContext context, AttrAss semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ATTR_ASS__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ATTR_ASS__NAME));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.ATTR_ASS__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.ATTR_ASS__EXPR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_EventBlock(ISerializationContext context, EventBlock semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.EVENT_BLOCK__KEY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.EVENT_BLOCK__KEY));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.BLOCK__STMT_BLOCK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.BLOCK__STMT_BLOCK));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *     Expr.Operation_1_0 returns ExprVar
	 ...
	 *     ExprVar returns ExprVar
	 *
	 * Constraint:
	 *     expr=Expr
	 */
	protected void sequence_ExprVar(ISerializationContext context, ExprVar semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.EXPR_VAR__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.EXPR_VAR__EXPR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getExprVarAccess().getExprExprParserRuleCall_1_0(), semanticObject.getExpr());
		feeder.finish();
	}
	...
	protected void sequence_ForStmt(ISerializationContext context, ForStmt semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.FOR_STMT__INIT_STMT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.FOR_STMT__INIT_STMT));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.FOR_STMT__END_CONDITION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.FOR_STMT__END_CONDITION));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.FOR_STMT__LOOP_STMT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.FOR_STMT__LOOP_STMT));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.FOR_STMT__STMT_BLOCK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.FOR_STMT__STMT_BLOCK));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *     EndStmt returns IntLiteral
	 *     Expr returns IntLiteral
	 *     Expr.Operation_1_0 returns IntLiteral
	 ...
	 *     Expr.Operation_1_0 returns UnaryOperation
	...
	protected void sequence_VarArray(ISerializationContext context, VarArray semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.VAR_ARRAY__INDEX_EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.VAR_ARRAY__INDEX_EXPR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_VarProp(ISerializationContext context, VarProp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.VAR_PROP__EXT_ID) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.VAR_PROP__EXT_ID));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *     Var returns Var
	 *     Expr returns Var
	 *     Expr.Operation_1_0 returns Var
	 *     AndExpr returns Var
	 ...
	 *
	 * Constraint:
	 *     (whileCondition=Expr stmtBlock=StmtBlock)
	 */
	protected void sequence_WhileStmt(ISerializationContext context, WhileStmt semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.WHILE_STMT__WHILE_CONDITION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.WHILE_STMT__WHILE_CONDITION));
			if (transientValues.isValueTransient(semanticObject, GamePackage.Literals.WHILE_STMT__STMT_BLOCK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GamePackage.Literals.WHILE_STMT__STMT_BLOCK));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWhileStmtAccess().getWhileConditionExprParserRuleCall_2_0(), semanticObject.getWhileCondition());
		feeder.accept(grammarAccess.getWhileStmtAccess().getStmtBlockStmtBlockParserRuleCall_4_0(), semanticObject.getStmtBlock());
		feeder.finish();
	}
